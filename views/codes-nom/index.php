...
/* @var $searchModel app\models\CodesNomSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Noms: codes');
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="codes-nom-index">
    <div id="ajaxCrudDatatable">
        <?= GridView::widget([
            ...
            'panel' => [
                'type' => 'info',
                'heading' => '<i class="glyphicon glyphicon-list"></i> ' . Yii::t('app', 'Noms: codes'),
